...
window.FEATURED = [
  {
    ...
    blurb: "A 162-participant controlled study across six LLMs: user ratings track pre-interaction framing of model capability, not measured task performance.",
    tag: "Human-AI Interaction",
    links: { arxiv: "https://arxiv.org/abs/2607.05113" },
  },
  {
    id: "scope",
    year: 2026,
    ...
    blurb: "Conformal prediction for LLM-as-judge pipelines: calibrated pairwise judgments with statistical coverage guarantees, abstaining when uncertain.",
    tag: "Evaluation · Methods",
    links: { icml: "https://icml.cc/virtual/2026/poster/62431", arxiv: "https://arxiv.org/abs/2602.13110" },
  },
  {
    id: "common-to-whom",
    year: 2026,
    ...
    blurb: "A benchmark of region-specific cultural commonsense across India. LLMs encode a narrow slice of regional knowledge and err systematically outside it.",
    tag: "Culture · Evaluation",
    links: {
      acl: "https://aclanthology.org/2026.acl-long.249/",
  ...
  },
  {
    ...
    blurb: "Intervening on chain-of-thought traces shows they causally shape final answers, while models' own self-reports fail to acknowledge that influence.",
    tag: "Interpretability",
    links: { acl: "https://aclanthology.org/2026.acl-long.1986.pdf", arxiv: "https://arxiv.org/abs/2603.20620" },
  },
  {
    id: "memory-dial",
    year: 2026,
    ...
    blurb: "A training framework that treats memorization as a controllable parameter, increasing or suppressing it for targeted data during training.",
    tag: "Interpretability · Methods",
    links: {
      acl: "https://aclanthology.org/2026.findings-acl.179/",
  ...
  },
  {
    ...
    blurb: "Training models to treat groups differently when appropriate can drift into differential harm. DART detects and repairs this drift through a distill, audit, and repair cycle.",
    tag: "Safety · Fairness",
    links: { acl: "https://aclanthology.org/2026.findings-acl.244/", arxiv: "https://arxiv.org/abs/2604.16845" },
  },
  {
    id: "connections",
    year: 2024,
    ...
    blurb: "358 word puzzles that penalize fast, intuitive guessing. GPT-4 trails humans by about 30 points, and Chain-of-Thought gains shrink as difficulty rises.",
  ...
  },
  {
    ...
    blurb: "Bias evaluation that accounts for context: 2,700 sentences escalating in severity across 9 demographics. Aligning models to human judgments improves downstream answer rates by up to 191%.",
...
window.PUBLICATIONS = [
  ...
  { id: "reasoning-traces", year: 2026, title: "Reasoning Traces Shape Outputs but Models Won't Say So", authors: ["Yijie Hao", "Lingjie Chen", "Ali Emami", "Joyce Ho"], venue: "ACL 2026", tag: "Interpretability", links: { acl: "https://aclanthology.org/2026.acl-long.1986.pdf", arxiv: "https://arxiv.org/abs/2603.20620" } },
  { id: "dart", year: 2026, title: "DART: Mitigating Harm Drift in Difference-Aware LLMs via Distill-Audit-Repair Training", authors: ["Ziwen Pan", "Zihan Liang", "Jad Kabbara", "Ali Emami"], venue: "ACL 2026 Findings", tag: "Safety", links: { acl: "https://aclanthology.org/2026.findings-acl.244/", arxiv: "https://arxiv.org/abs/2604.16845" } },
  { id: "memory-dial", year: 2026, title: "Memory Dial: A Training Framework for Controllable Memorization in Language Models", authors: ["Xiangbo Zhang", "Ali Emami"], venue: "ACL 2026 Findings", tag: "Methods", links: { acl: "https://aclanthology.org/2026.findings-acl.179/", arxiv: "https://arxiv.org/abs/2604.05074", code: "https://github.com/xiangbo05/MemoryDial_Public" } },
  ...
  { id: "scope", year: 2026, title: "SCOPE: Selective Conformal Optimized Pairwise LLM Judging", authors: ["Sher Badshah", "Ali Emami", "Hassan Sajjad"], venue: "ICML 2026", tag: "Evaluation", links: { icml: "https://icml.cc/virtual/2026/poster/62431", arxiv: "https://arxiv.org/abs/2602.13110" } },
...
window.NEWS = [
  ...
  { year: 2026, date: "Apr 2026", text: "Six papers accepted at ACL 2026. Topics: search-augmented evaluation, regional cultural commonsense in India, reasoning traces, harm drift, controllable memorization, and privacy-preserving QA over glucose data.", highlight: true },
  { year: 2026, date: "Apr 2026", text: "\"Common to Whom? Regional Cultural Commonsense and LLM Bias in India\" (ACL 2026 Main): preprint and INDICA benchmark released.", links: { acl: "https://aclanthology.org/2026.acl-long.249/", arxiv: "https://arxiv.org/abs/2601.15550", data: "https://huggingface.co/datasets/Sangmitra-06/INDICA" } },
  { year: 2026, date: "Apr 2026", text: "\"Memory Dial: A Training Framework for Controllable Memorization in Language Models\" (ACL 2026 Findings): preprint and code released.", links: { acl: "https://aclanthology.org/2026.findings-acl.179/", arxiv: "https://arxiv.org/abs/2604.05074", code: "https://github.com/xiangbo05/MemoryDial_Public" } },
  ...
  { year: 2025, date: "Sep 2025", text: "Taarof paper featured in Ars Technica and PC Gamer.", link: "https://arstechnica.com/ai/2025/09/when-no-means-yes-why-ai-chatbots-cant-process-persian-social-etiquette/", highlight: true },
...
window.GROUP = {
  current: [
    ...
    { name: "Conrad Feng", role: "Undergraduate, Emory CS" },
  ...
  alumni: [
    ...
    { name: "Pu (Tom) Suo", role: "Undergraduate, Emory CS (2026)" },
    { name: "Xiangbo Zhang", role: "Undergraduate, Georgia Tech / Emory CS intern (2025–2026)" },
