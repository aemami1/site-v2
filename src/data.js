...
window.FEATURED = [
  ...
  },
  {
    ...
    authors: ["Zihan Pan", "Zihan Liang", "Jad Kabbara", "Ali Emami"],
...
window.PUBLICATIONS = [
  ...
  { id: "common-to-whom", year: 2026, title: "Common to Whom? Regional Cultural Commonsense and LLM Bias in India", authors: ["Sangmitra Madhusudan", "Tanmay S. More", "Silvia Buongiorno", "Renata Dividino", "Jad Kabbara", "Ali Emami"], venue: "ACL 2026", tag: "Culture", links: { arxiv: "https://arxiv.org/abs/2601.15550", data: "https://huggingface.co/datasets/Sangmitra-06/INDICA" } },
  { id: "reasoning-traces", year: 2026, title: "Reasoning Traces Shape Outputs but Models Won't Say So", authors: ["Yiming Hao", "Lu Chen", "Ali Emami", "Joyce C. Ho"], venue: "ACL 2026", tag: "Interpretability", links: { arxiv: "https://arxiv.org/abs/2603.20620" } },
  { id: "dart", year: 2026, title: "DART: Mitigating Harm Drift in Difference-Aware LLMs via Distill-Audit-Repair Training", authors: ["Zihan Pan", "Zihan Liang", "Jad Kabbara", "Ali Emami"], venue: "ACL 2026 Findings", tag: "Safety" },
  ...
  { id: "cgm", year: 2026, title: "If Only My CGM Could Speak: A Privacy-Preserving Agent for Question Answering over Continuous Glucose Data", authors: ["Yuchen Cui", "Ali Emami", "Temiloluwa Prioleau", "Nikhil Singh"], venue: "ACL 2026 Findings", tag: "Applied", links: { arxiv: "https://arxiv.org/abs/2604.17133" } },
  // EACL 2026
  ...
  { id: "beyond-content", year: 2025, title: "Beyond Content: How Grammatical Gender Shapes Visual Representation in Text-to-Image Models", authors: ["Mohamed Saeed", "Shaina Raza", "Ashmal Vayani", "Muhammad Abdul-Mageed", "Ali Emami", "Shady Shehata"], venue: "EMNLP 2025 Findings", tag: "Vision", links: { arxiv: "https://arxiv.org/abs/2508.03199" } },
  ...
  { id: "time-capsules", year: 2025, title: "Fine-Tuned LLMs are \u201CTime Capsules\u201D for Tracking Societal Bias Through Books", authors: ["Sangmitra Madhusudan", "Robert Morabito", "Skye Reed", "Nikta Gohari Sadr", "Ali Emami"], venue: "NAACL 2025", tag: "Bias", links: { acl: "https://aclanthology.org/2025.naacl-long.118/", arxiv: "https://arxiv.org/abs/2502.05331" } },
  // 2024
  { id: "epi", year: 2024, title: "Can We Afford The Perfect Prompt? Balancing Cost and Accuracy with the Economical Prompting Index", authors: ["Tyler McDonald", "Anthony Colosimo", "Ali Emami"], venue: "COLING 2025 (Oral)", tag: "Methods", links: { acl: "https://aclanthology.org/2025.coling-main.471/", arxiv: "https://arxiv.org/abs/2412.01690" } },
  { id: "connections", year: 2024, title: "NYT-Connections: A Deceptively Simple Text Classification Task that Stumps System-1 Thinkers", authors: ["Angel Loredo", "Tyler McDonald", "Ali Emami"], venue: "COLING 2025 (Oral)", tag: "Reasoning", award: "Best Dataset Paper", links: { acl: "https://aclanthology.org/2025.coling-main.134/", arxiv: "https://arxiv.org/abs/2412.01621" } },
  ...
  { id: "winovis", year: 2024, title: "Picturing Ambiguity: A Visual Twist on the Winograd Schema Challenge", authors: ["Brendan Park", "Madeline Janecek", "Yifeng Li", "Ali Emami"], venue: "ACL 2024 (Oral)", tag: "Reasoning", links: { acl: "https://aclanthology.org/2024.acl-long.22/" } },
  ...
  { id: "turing", year: 2023, title: "The Turing Quest: Can Transformers Make Good NPCs?", authors: ["QiQi Chen Gao", "Ali Emami"], venue: "ACL SRW 2023", tag: "Applied", links: { acl: "https://aclanthology.org/2023.acl-srw.17/" } },
  { id: "adept", year: 2021, title: "ADEPT: An Adjective-Dependent Plausibility Task", authors: ["Ali Emami", "Ian Porada", "Alexandra Olteanu", "Kaheer Suleman", "Adam Trischler", "Jackie C. K. Cheung"], venue: "ACL-IJCNLP 2021 (Oral)", tag: "Reasoning", links: { acl: "https://aclanthology.org/2021.acl-long.553/", code: "https://github.com/aemami1/ADEPT" } },
  { id: "analysis", year: 2020, title: "An Analysis of Dataset Overlap on Winograd-Style Tasks", authors: ["Ali Emami", "Adam Trischler", "Kaheer Suleman", "Jackie C. K. Cheung"], venue: "COLING 2020 (Oral)", tag: "Reasoning", links: { acl: "https://aclanthology.org/2020.coling-main.515/", arxiv: "https://arxiv.org/abs/2011.04767" } },
  { id: "knowref", year: 2019, title: "The KnowRef Coreference Corpus: Removing Gender and Number Cues for Difficult Pronominal Anaphora Resolution", authors: ["Ali Emami", "Paul Trichelair", "Adam Trischler", "Kaheer Suleman", "Hannes Schulz", "Jackie C. K. Cheung"], venue: "ACL 2019", tag: "Reasoning", links: { acl: "https://aclanthology.org/P19-1386/", arxiv: "https://arxiv.org/abs/1811.01747" } },
  { id: "reasonable", year: 2019, title: "How Reasonable are Common-Sense Reasoning Tasks: A Case-Study on the Winograd Schema Challenge and SWAG", authors: ["Ali Emami", "Paul Trichelair", "Adam Trischler", "Kaheer Suleman", "Hannes Schulz", "Jackie C. K. Cheung"], venue: "EMNLP-IJCNLP 2019 (Oral)", tag: "Evaluation", links: { acl: "https://aclanthology.org/D19-1335/", arxiv: "https://arxiv.org/abs/1811.01778" } },
  { id: "knowledge", year: 2018, title: "A Knowledge Hunting Framework for Common Sense Reasoning", authors: ["Ali Emami", "Noelia De La Cruz", "Adam Trischler", "Kaheer Suleman", "Jackie C. K. Cheung"], venue: "EMNLP 2018", tag: "Reasoning", links: { acl: "https://aclanthology.org/D18-1220/", arxiv: "https://arxiv.org/abs/1810.01375" } },
  { id: "generalized", year: 2018, title: "A Generalized Knowledge Hunting Framework for the Winograd Schema Challenge", authors: ["Ali Emami", "Adam Trischler", "Kaheer Suleman", "Jackie C. K. Cheung"], venue: "NAACL SRW 2018", tag: "Reasoning", award: "Best Paper", links: { acl: "https://aclanthology.org/N18-4004/" } },
];
...
window.GROUP = {
  current: [
    ...
    { name: "Winston Zeng", role: "PhD, Spring 2026 – Present", note: "Co-supervised with Prof. Jinho Choi" },
    // MSc students
